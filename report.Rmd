...
table_1 <- kable(readRDS('outputs/averages_results.RDS'), align = 'rr',digits = 2,format = 'html',
...
```{r, echo = F, results = 'asis'}
table_2 <- kable(readRDS('outputs/rho_0_models')[,1:8], align = 'rr',digits = 2,format = 'html',
